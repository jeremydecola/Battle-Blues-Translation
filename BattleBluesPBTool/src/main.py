...
root = Tk()
root.geometry("564x849")
root.iconbitmap(default=project_root+"\\grenade.ico")
frame = Frame(root)
frame.pack()

bg = ImageTk.PhotoImage(Image.open(project_root+"\\bg.jpg"))
...
midframe = Frame(root)
midframe.place(in_=root, anchor="c", relx=.5, rely=.5)

title_label = Label(topframe, text="BATTLE BLUES PATCH AND BALANCE TOOL!")
title_label.configure(font=("Monaco", 18, "bold"))
title_label.pack()

progress_label = Label(topframe, text="Current Progress:")
progress_label.configure(font=("Monaco", 14, "bold"))
progress_label.pack()
progress = Label(topframe, text="[Waiting For User Input]")
progress.configure(font=("Monaco", 14, "bold"), foreground = "red")
progress.pack()
...
label_browse.configure(font=("Monaco", 14, "bold"))
label_browse.pack()
...
label_ds.configure(font=("Monaco", 14, "bold"))
label_ds.pack()

choice = IntVar(value = 2)
Easy = Radiobutton(midframe, text="EASY", variable = choice,
                         value = 1, justify = "left")
Easy.configure(font=("Monaco", 14, "bold"))
Easy.pack(padx = 5, pady = 5, anchor = W)
Normal = Radiobutton(midframe, text="NORMAL", variable = choice,
                         value = 2, justify = "left")
Normal.configure(font=("Monaco", 14, "bold"))
Normal.pack(padx = 5, pady = 5, anchor = W)
Hard = Radiobutton(midframe, text="HARD", variable = choice,
                         value = 3, justify = "left")
Hard.configure(font=("Monaco", 14, "bold"))
Hard.pack(padx = 5, pady = 5, anchor = W)
Impossible = Radiobutton(midframe, text="IMPOSSIBLE", variable = choice,
                         value = 4, justify = "left")
Impossible.configure(font=("Monaco", 14, "bold"))
Impossible.pack(padx = 5, pady = 5, anchor = W)

root.title("Battle Blues Patch and Balance Tool v0.1")
